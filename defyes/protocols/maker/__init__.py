...
from defyes.porfolio import ERC20Token, Frozen, KwInit, NativeToken, Position, default, repr_for
...
# class EthereumSdai(abi.Sdai):
#    address = "0x83F20F44975D03b1b09e64809B757c47f942BEeA"
#
#
# class GnosisSdai(Sdai):
#    address = "0xaf204776c7245bF4147c2612BF6e5972Ee483701"
#    dai = Address.ZERO
#
# class EthereumSdaiToken(Token):
#    abi_class = EthereumSdai
...
#        DAI = ERC20Token.instances.get(chain=Chain.ETHEREUM, address=EthereumTokenAddr.DAI)
#        #sDAI = _(address="0x83F20F44975D03b1b09e64809B757c47f942BEeA", unwrapped=DAI)
#
#    class gnosis:
#        #xDAI = NativeToken(chain=Chain.GNOSIS, symbol="xDAI")
#        #sDAI = ERC20Token(chain=Chain.GNOSIS, address="0xaf204776c7245bF4147c2612BF6e5972Ee483701", unwrapped=DAI)
#        sDAI = ERC20Token(chain=Chain.GNOSIS, address="0xaf204776c7245bF4147c2612BF6e5972Ee483701")
...
class Positions(Frozen, KwInit):
        ...
        for vault_id in cdp.get_vault_ids(ProxyRegistry(self.blockchain, block).proxies(wallet)):
            ...
            yield self.Vault(
                ...
                underlyings={
                    ...
                    UnderlyingTokenAmount(token=DAI, amount=-1 * art * rate, block=self.block),
                },
            )
    ...
    def dsr(self) -> DSR:
        ...
        yield self.DSR(underlyings={UnderlyingTokenAmount(token=DAI, amount=dsr.decimal_pie_of(self.wallet))})
    ...
    def pot(self) -> Pot:
        ...
        yield self.Pot(underlying={UnderlyingTokenAmount(token=DAI, amount=pot.decimal_pie_1(self.wallet) * pot.chi)})
    ...
    def iou(self) -> Iou:
        ...
        yield self.Iou(underlying={UnderlyingTokenAmount(token=MKR, amount_teu=iou.balance_of(self.wallet))})
